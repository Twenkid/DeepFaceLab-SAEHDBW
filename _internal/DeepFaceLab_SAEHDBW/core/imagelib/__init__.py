...
from .reduce_colors import reduce_colors, reduce_colors_bw #bw: 23-5-2022

from .color_transfer import color_transfer, color_transfer_mix, color_transfer_sot, color_transfer_mkl, color_transfer_idt, color_hist_match, reinhard_color_transfer, linear_color_transfer, bw_hist_match 

# bw_hist_match  #22-5-2022
